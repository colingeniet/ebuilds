...
RDEPEND="
	>=dev-haskell/aeson-0.11.3.0:=[profile?] <dev-haskell/aeson-1.5:=[profile?]
	...
	>=dev-haskell/regex-tdfa-1.2.2:=[profile?] <dev-haskell/regex-tdfa-1.4:=[profile?]
